...
import { MdSplitscreen, MdAddCard, MdAddChart, MdSearch } from "react-icons/md";
import Footer from '../components/Footer';
import WalletPage from '../pages/WalletPage';

const HomePage = () => {
    return (
        <div className="font-inter" style={{ backgroundColor: '#faf8f5' }}> {/* Correct the background color here */}
            <Header />
            <div className="flex flex-col sm:flex-row">
                {/* Balance Display */}
                <div className="flex-1 sm:w-1/2 fixed z-10 overflow-x-hidden pt-20 bg-white left-0">
                    ...
                    <div className="bg-white h-1/6 w-8/12 mt-4 ml-32 rounded-xl">
                        <div className="p-4">
                            <p className="p-2 text-lg font-bold">Recent Activity</p>
                ...
                {/* Buttons */}
                <div className="flex-1 sm:w-1/2 fixed overflow-x-hidden right-0">
